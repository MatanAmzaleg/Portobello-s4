            ...
            <nav>
                <section class="nav-logo">
                    <router-link to="/" class="logo">
                        <svg aria-label="Portobello" height="22.5" role="img" viewBox="0 0 55 64" width="25"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            class="LogoTrello__Logo-sc-11mphmv-0 dmCGMv">
                            <linearGradient id="trello-logo-gradient-defaultMJFtCCgVhXrVl7v9HA7EH_mobile"
                                x1="50.048061%" x2="50.048061%" y1="100%" y2="0%">
                            ...
                            <g fill="none" fill-rule="evenodd">
                                <path
                                    ...
                                    fill="url(#trello-logo-gradient-defaultMJFtCCgVhXrVl7v9HA7EH_mobile)"></path>
                            </g>
                        </svg>
