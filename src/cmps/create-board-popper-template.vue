    ...
    <div class="popper-content">
        ...
        <div class="content">
            <div class="content-board-img">
                <div class="board-img"
                    :style="selectedBackground?.bgColor ? { 'background-color': selectedBackground?.bgColor } : selectedBackground?.imgUrl ? { 'background-image': 'url( ' + selectedBackground?.imgUrl + ')', 'background-size': 'cover' } : ''">
